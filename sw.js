const CACHE_NAME = "vela-ai-v620";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=618",
  "./chat-design.css?v=617",
  "./focus-design.css?v=617",
  "./home-design.css?v=618",
  "./profile-design.css?v=620",
  "./app.js?v=620",
  "./icons/figma-profile/persona.svg",
  "./icons/figma-profile/memory.svg",
  "./icons/figma-profile/style.svg",
  "./icons/figma-profile/backup.svg",
  "./icons/figma-profile/chevron.svg",
  "./icons/figma-profile/divider.svg",
  "./icons/figma-home/arrow-left.svg",
  "./icons/figma-home/arrow-right.svg",
  "./icons/figma-home/book.svg",
  "./icons/figma-home/diary.svg",
  "./icons/figma-focus/outer-ring.svg",
  "./icons/figma-focus/timer-ring.svg",
  "./icons/figma-focus/controls.svg",
  "./icons/figma-focus/chat.svg",
  "./icons/figma-focus/clock.svg",
  "./icons/figma-focus/home.svg",
  "./icons/figma-focus/user.svg",
  "./icons/figma-focus/api.svg",
  "./icons/figma-chat/chat.svg",
  "./icons/figma-chat/clock.svg",
  "./icons/figma-chat/home.svg",
  "./icons/figma-chat/user.svg",
  "./icons/figma-chat/api.svg",
  "./icons/figma-chat/add.svg",
  "./icons/figma-chat/deeptalk.svg",
  "./icons/figma-chat/image.svg",
  ...
  "./manifest.webmanifest?v=619",
  "./icons/vela-mark.svg",
  "./icons/vela-favicon-32.png",
  "./icons/vela-app-192.png",
  "./icons/vela-app-512.png",
  "./icons/vela-apple-touch-180.png",
];
...
self.addEventListener("push", (event) => {
  event.waitUntil((async () => {
    ...
    await self.registration.showNotification(payload.title || "Vela", {
      ...
      icon: "./icons/vela-app-192.png",
      badge: "./icons/vela-app-192.png",
